...
if __name__ == '__main__':
    ...
    CLIENT_KEY = 'sbawd15l5wth8kl3wi'
    CLIENT_SECRET = 'eAi59VvUI9ir4RrjYbTtWuEPnm0VwcYw'

    # For local testing, use the following redirect URI.
    # Make sure this URL is registered in your TikTok app settings.
    REDIRECT_URI = 'http://127.0.0.1:5000/callback/'

    login_kit = LoginKit(client_key=CLIENT_KEY,
                               client_secret=CLIENT_SECRET)

    # Start the OAuth server to handle the login flow:
    login_kit.oath_server(timeout=60)

    if login_kit.current_access_token:
